...
mulitiplicated_xy_dict = {}
I = 3
J = 3
for i in range(I):
    mulitiplicated_xy_dict[i] = {}
    for j in range(J):
        mulitiplicated_xy_dict[i][j] = i*j
print(mulitiplicated_xy_dict)

mulitiplicated_xy_dict = {i:{j:(i*j) for j in range(J)} for i in range(I)}
print(mulitiplicated_xy_dict)
